...
function CreateNewSecret {
    ...
    $secretItemFields = ((findFieldId $template "Machine"), (findFieldId $template "Username"), (findFieldId $template "Password"), (findFieldId $template "Notes"))
...
$NewUsers = new-object String[] 4
$NewUsers[0] = "ws-" + $newUser + "-D"
$NewUsers[1] = "ws-" + $newUser + "-T"
$NewUsers[2] = "ws-" + $newUser + "-U"
$NewUsers[3] = "ws-" + $newUser
